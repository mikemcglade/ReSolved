...
public class GameManager : MonoBehaviour
{
    ...
    private const float returnToStartScreenDelay = 5f;
    private const float rainIntensity = 0.5f;
    ...
    public void GameOver()
    {
        ...
        Invoke("ReturnToStartScreen", returnToStartScreenDelay);
    ...
    private void LevelComplete()
    {
        ...
        Invoke("LoadNextLevel", nextLevelDelay); // Adjust delay as needed
    }
